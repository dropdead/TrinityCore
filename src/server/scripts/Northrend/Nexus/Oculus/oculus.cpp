...
#define GOSSIP_ITEM_DRAKES         "Y ahora, hacia donde vamos desde aqui?"         //"So where do we go from here?"
#define GOSSIP_ITEM_BELGARISTRASZ1 "Quiero volar con el Vuelo Rojo"                 //"I want to fly on the wings of the Red Flight"
#define GOSSIP_ITEM_BELGARISTRASZ2 "Que habilidades tienen los dracos rubi?"        //"What abilities do Ruby Drakes have?"
#define GOSSIP_ITEM_VERDISA1       "Quiero volar con el Vuelo Verde"                //"I want to fly on the wings of the Green Flight"
#define GOSSIP_ITEM_VERDISA2       "Que habilidades tienen los dracos esmeralda?"   //"What abilities do Emerald Drakes have?"
#define GOSSIP_ITEM_ETERNOS1       "Quiero volar con el Vuelo Bronce"               //"I want to fly on the wings of the Bronze Flight"
#define GOSSIP_ITEM_ETERNOS2       "Que habilidades tienen los dracos ambar?"       //"What abilities do Amber Drakes have?"
