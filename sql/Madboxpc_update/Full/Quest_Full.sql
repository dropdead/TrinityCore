...
-- UPDATE `quest_template` SET `SkillOrClassMask`=-32 WHERE `Id` IN (13795, 13791, 13813, 13788, 13812, 13793, 13814, 13864, 13863);
...
-- Among the Champions (A, H)
-- Battle Before The Citadel (A, H)
-- UPDATE `quest_template` SET `SkillOrClassMask`=-1503 WHERE `Id` IN (13794, 13788, 13789, 13810, 13682, 13809, 13790, 13811, 13861, 13862);
...
-- UPDATE `quest_template` SET `ReqCreatureOrGOId1` = -185156, `ObjectiveText1` = 'Karynaku freed', `ReqCreatureOrGOId2` = 11980 , `ObjectiveText2` = 'Zuluhed the Whacked slain'  WHERE Id = 10866;
