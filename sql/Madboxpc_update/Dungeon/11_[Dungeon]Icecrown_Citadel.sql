...
-- Update Dmg Boss
-- Lord Marrowgar
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '45' WHERE `entry` =36612;-- Valor Anterior 35
-- Lady Deathwhisper
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '11.5' WHERE  `entry` =36855;-- Valor Anterior 7.5
-- Deathbringer
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '45' WHERE `entry` =37813;-- Valor Anterior 35
-- Rotface
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '45' WHERE `entry` =36627;-- Valor Anterior 35
-- 36899 Bigg Ozze
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '9.5' WHERE  `entry` =36899;-- Valor Anterior 7.5
-- Festergut
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '45' WHERE `entry` =36626;-- Valor Anterior 35
-- Sister Svalna
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '11.5' WHERE  `entry` =37126;-- Valor Anterior 7.5