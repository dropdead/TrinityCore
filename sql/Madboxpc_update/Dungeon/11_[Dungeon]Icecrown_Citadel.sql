...
UPDATE `creature_template` SET `mechanic_immune_mask` = `mechanic_immune_mask`|1|2|8|16|32|64|128|256|512|1024|2048|4096|8192|65536|131072|524288|4194304|8388608|33554432|67108864|536870912 WHERE `entry` IN (37697,38604,38758,38759,37562,38602,38760,38761);
...
-- Lady Deathwhisper
UPDATE `creature_template` SET  `dmg_multiplier` =  '10.5' WHERE  `entry` =36855;-- Valor Anterior 7.5
-- Deathbringer
...
-- Sister Svalna
UPDATE `creature_template` SET  `dmg_multiplier` =  '10.5' WHERE  `entry` =37126;-- Valor Anterior 7.5